...
"""Preprocessed volume representation for the Xray Simulator.
...
class VolumeMetadata:
    ...
    Attributes:
        ...
        hu_to_mu: Serialized HU → μ transfer function used for the conversion. Recorded
            so that a cached μ volume can be traced back to the mapping that produced it.
        anatomical_frame: Patient frame the volume axes are in, e.g. "LPS" for the
            canonical frame written by the digital-twin preprocessing. None means the
            orientation is unknown, in which case the anatomical view presets in
            xray_simulator.geometry do not apply.
        source_orientation: Orientation code of the acquisition before reorientation,
